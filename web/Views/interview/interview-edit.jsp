...
<head>
    ...
    <title>Chỉnh sửa lịch phỏng vấn</title>
            ...
            <div class="col-12 col-md-8 col-lg-6 mx-auto">
                <nav class="navbar navbar-light bg-light mb-4">
                    <div class="container-fluid">
                        ...
                        <span class="navbar-text">
                            <i class="fas fa-edit"></i> Chỉnh sửa lịch phỏng vấn
                        </span>
                    </div>
                </nav>
                ...
                <c:if test="${empty interview}">
                    <div class="alert alert-warning">
                        Không tìm thấy thông tin lịch phỏng vấn.
                    </div>
                </c:if>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">
                                <i class="fas fa-edit"></i> Chỉnh sửa thông tin lịch phỏng vấn
                            </h5>
                        </div>
                        <div class="card-body">
                            <form action="interview" method="POST">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="applicationId" name="applicationId" 
                                               value="${interview.applicationId}" required min="1">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="locationId" name="locationId" 
                                               value="${interview.locationId}" required min="1">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="datetime-local" class="form-control" id="scheduledAt" name="scheduledAt" 
                                               value="${interview.scheduledAt}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="interviewerFullname" name="interviewerFullname" 
                                               value="${interview.interviewerFullname}" required maxlength="256">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="4" 
                                              maxlength="4000">${interview.notes}</textarea>
