...
<main class="ml-64 p-8 min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <script>
            // ✅ Kích hoạt SimpleDataTable (Search + Sort + Pagination)
                ...
                document.querySelectorAll(".view-detail-btn").forEach(btn => {
                    btn.addEventListener("click", () => {
                        ...
                        detailContent.innerHTML = `
                            <p><strong>Mã đơn:</strong> #${btn.dataset.id}</p>
                            <p><strong>Ứng viên:</strong> ${tr.children[1].innerText}</p>
                            <p><strong>Vị trí:</strong> ${tr.children[2].innerText}</p>
                            <p><strong>Trạng thái:</strong> ${tr.querySelector("span").innerText}</p>
                            <p><strong>Ngày nộp:</strong> ${tr.children[4].innerText}</p>
                            <hr class="my-2">
                            <p class="text-gray-500 italic">Chi tiết sẽ được tải từ DB trong bản triển khai đầy đủ.</p>
                        `;
