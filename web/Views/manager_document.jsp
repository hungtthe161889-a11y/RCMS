...
<head>
  ...
  <style>
    .dropzone{border:2px dashed #ced4da;border-radius:.75rem;padding:2rem;text-align:center;background:#f8f9fa;transition:.2s}
    .dropzone.dragover{border-color:#0d6efd;background:#eef5ff}
    .file-icon{width:40px;height:40px;border-radius:.5rem;display:inline-flex;align-items:center;justify-content:center;font-weight:700}
    ...
    <div class="card-body">
      ...
      <form id="uploadForm" class="row g-3" method="post" action="${pageContext.request.contextPath}/documents" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
          ...
          <input name="title" class="form-control" placeholder="VD: Chứng chỉ IELTS 7.0">
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          ...
          <input name="issuedBy" class="form-control" placeholder="VD: British Council">
        </div>
...
<script>
  ...
  input.addEventListener('change', () => { if (input.files.length) nameBox.textContent = input.files[0].name; });
</script>
